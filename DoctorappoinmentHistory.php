...
<html>
	...
	try{
		...
		$name=$_SESSION['a_d_name'];
		$select=$con->prepare("SELECT * FROM bookappoinment WHERE d_name='$name'"); 
		...
		<p><u>Doctor Appoinment History</u></p>
		<br/>
        <table border="1">
		<tr>
		<th>Doctor Name</th>
		...
		<td><?php echo $p['s_d_s']?></td>
		<td><?php echo $p['s_a_d_name']?></td>
		<td><?php echo $p['s_a_d_date']?></td>
		</tr>
